...
echo image=images/avatar/$2/$1.png > mods/core/animations/avatar/$2/$1.txt
cat hero.txt >> mods/core/animations/avatar/$2/$1.txt
mv $1.png mods/core/images/avatar/$2/$1.png
cd tools/flare
./spritesheetpacker.py --images ../../mods/core/images/avatar/$2/$1.png --definitions ../../mods/core/animations/avatar/$2/$1.txt
